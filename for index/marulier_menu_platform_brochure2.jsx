export default function LaMartinaLanding() {
  const plans = [
    {
      name: 'Essential',
      setup: '$6,900 MXN',
      ...
      <section className="px-8 md:px-16 pt-10 pb-24">
        <nav className="flex items-center justify-between mb-20">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#ff2f68] flex items-center justify-center text-white font-bold text-xl shadow-lg">
              LM
            </div>

            <div>
              <h1 className="text-3xl md:text-4xl font-light">
                La <span className="font-semibold">Martina</span>
              </h1>

              <p className="uppercase tracking-[0.25em] text-xs text-[#ff2f68] mt-1">
                ...
                <div className="space-y-4">
                  {plan.features.map((feature) => (
                    <div key={feature} className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-[#ff2f68] mt-2"></div>
